...
describe('summary', () => {
  ...
  it('sets the result case correctly', () => {
    ...
    let testCases = [
      ...
      {
        name: 'contact and high risk symptoms outside of 14d',
        scores: { [CATEGORIES.CONTACT]: 1, [CATEGORIES.SYMPTOMS_HIGH]: 1 },
        contactWithinTwoWeeks: null,
        symptomsWithinTwoWeeksOfContact: false,
        expected: 2,
      },
      ...
      {
        name: 'no contact but high risk symptoms',
        scores: {
          [CATEGORIES.CONTACT]: 0,
